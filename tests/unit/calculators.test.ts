...
async function testCalculators() {
  ...
  console.log('    [PASS] Northstar agreement zero-fee override verified.');
  ...
  console.log('    [PASS] Standard SOP INR 250 fee applied after 30 min.');
  ...
  console.log('    [PASS] PICKED_UP order cancellation correctly rejected with RTO recommendation.');
  ...
  if (ord9001) {
    ...
    console.log('    [PASS] ORD-9001 correctly flagged as NEEDS_VERIFICATION.');
  }
  ...
  console.log('    [PASS] LumenWorks custom INR 300 credit override verified.');
  ...
  console.log('    [PASS] Standard SOP min(500, 10%) calculation verified.');
  ...
  console.log('    [PASS] Customer-fault delay correctly marked ineligible.');
  ...
  console.log('    [PASS] Northstar custom P1 15-minute SLA target verified.');
  ...
  console.log('    [PASS] Credential / API key leak automatically elevated to P1.');
